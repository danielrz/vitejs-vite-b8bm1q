...
function Favorite({ contact }) {
  ...
  const favorite = fetcher.formData ? fetcher.formData.get('favorite') : contact.favorite 
  // we set the favorite value before waiting for the response from the server
